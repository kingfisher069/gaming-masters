...
// Color Switcher Mouse Pointer
$(document).ready(function () {
  $(".white-bg, .light-bg, .lighter-bg, .mouseHoverDark").hover(
    function () {
      $("#magicMouseCursor").addClass("switcherCircle");
      $("#magicPointer").addClass("switcherPointer");
    },
    function () {
      $("#magicMouseCursor").removeClass("switcherCircle");
      $("#magicPointer").removeClass("switcherPointer");
    }
  );
});
$(document).ready(function () {
  $(".black-bg, .dark-bg, .mouseHoverWhite").hover(
    function () {
      $("#magicMouseCursor").addClass("switcherCircleDark");
      $("#magicPointer").addClass("switcherPointerDark");
    },
    function () {
      $("#magicMouseCursor").removeClass("switcherCircleDark");
      $("#magicPointer").removeClass("switcherPointerDark");
    }
  );
});
